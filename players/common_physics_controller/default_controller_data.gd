...
const JUMP_VELOCITY = -200.0 # -200
# down gravity multiplier
const DOWN_MULTIPLIER : float = 1.2 # 1.2
# air acceleration and deceleration multiplier (air control and air brake)
const AIR_ACCEL_MULTIPLIER : float = 0.9 # 0.9
...
const COYOTE_TIME : int = 5 # 5
const JUMP_BUFFER : int = 5 # 5
